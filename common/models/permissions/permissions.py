...
from .permissions_queryset import PermissionsQuerySet
...
class Permissions(models.Model):
    ...
    researchgroup = models.ForeignKey('research.Group', related_name='rankedpermissions', verbose_name='Research group', blank=True, null=True, on_delete=models.CASCADE)
